...
To query NotebookLM notebooks from Claude Code or Claude Desktop
(useful with the paper-replication and notebooklm-paper-to-implementation skills):
...
Restart after editing. First run may prompt for Google sign-in in the browser.
